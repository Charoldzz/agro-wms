-- ============================================================
-- 12 · create_entry_operation en EQUIVALENTE (lts/kgs)
-- Antes guardaba la cantidad en ENVASES (cajas x uds + sueltas).
-- Ahora guarda el equivalente, igual que el resto de la app y que el programa.
-- ============================================================
