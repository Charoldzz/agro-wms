  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={`Inventario autorizado para ${clientName}`}
        action={
      ...
      <section className="panel mb-4 border-campo-100 bg-white/95">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-950">Consulta segura de inventario</h2>
            <p className="mt-1 text-sm font-semibold text-slate-500">
              {profile?.full_name || user.email} solo puede ver stock, historial y comprobantes vinculados a su empresa.
            </p>
          </div>
        </div>
      </section>
